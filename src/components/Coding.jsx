    ...
    return(
        <div className="coding" id="coding">
            ...
            <div className="projectGroup">
                <CodingCard title={"Cinema World"} description={"A social platform to review movies."} image={filmreviews} linkIURL={"https://github.com/palina0k/FilmReviews/tree/main"} />
